  ...
  <Container>
    <Nav className="justify-content-start">
      ...
      <ul className="list-group">
        <li className="list-group-item"><Nav.Link href="#pricing" className="mx-3 text-light display-7">Zespół</Nav.Link></li>
        <liclassName="list-group-item"><Nav.Link href="#pricing" className="mx-3 text-light display-7">Zespół</Nav.Link></li>
        <li><Nav.Link href="#pricing" className="mx-3 text-light display-7">Zespół</Nav.Link></li>
      </ul>
