...
<div> 
  <div className=" mt-4 very-bold display-7">Szanowni Pacjenci,</div>
 <div=text-center   W związku z epidemią wirusa COVID-19, w trosce o bezpieczeństwo Państwa oraz naszych pracowników,
uprzejmie prosimy o zapoznanie się i stosowanie do poniższej
PROCEDURY NA CZAS PANDEMII COVID-19 W CENTRUM STOMATOLOGII UNI-DENT s.c.
</div>

<div>
<div className=" mt-4 very-bold display-7">REJESTRACJA:</div>

<div className="text-left">
- zalecamy telefoniczną rejestrację wizyt
- zalecamy, by Pacjenci z objawami grypopodobnymi: gorączka, kaszel, duszność itp., przesunęli termin swojej wizyty o co najmniej 14 dni
- zalecamy, by Pacjenci powyżej 65. r.ż. oraz z chorobami współistniejącymi przenieśli wizytę na późniejszy termin
- prosimy o punktualne przybycie do gabinetu i - jeśli jest to możliwe - bez osób towarzyszących
</div>
</div>
<div>
<div className=" mt-4 very-bold display-7">2. WIZYTA W GABINECIE:</div>

- po wejściu do recepcji prosimy Państwa o zdezynfekowanie rąk i schowanie maseczki - asystentka zmierzy Państwu temperaturę ciała. Jeśli wyniesie powyżej 37,3°C, wizyta musi zostać przełożona o minimum 14 dni - prosimy o podpisanie oświadczenie dot. COVID-19 - bezpośrednio przed wykonanym zabiegiem prosimy Państwa o przepłukanie ust roztworem płynu Eludril.
</div>
</div>
