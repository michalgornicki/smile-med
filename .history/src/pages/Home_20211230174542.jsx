    ...
    <Carousel controls={false} indicators={false} variant="dark" fade interval="3000" pause="none">
      <Carousel.Item className="">
        ...
        <Carousel.Caption className="mobile-hide">
          <p className="display-7 my-0 text-white bg-black mx-auto ">
      ...
      <Carousel.Item>
        ...
        <Carousel.Caption className="mobile-hide">
          <p className="display-7 my-0  text-white bg-black">Poznaj nasz personel</p>
      ...
      <Carousel.Item>
        ...
        <Carousel.Caption className="mobile-hide">
          <p className="display-7 my-0  text-white bg-black">
