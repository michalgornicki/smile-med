...
<Navbar expand="lg" variant="light" bg="light">
  <Container>
  <Navbar.Brand href="#home"><span className="display-5">SMILE MED</span></Navbar.Brand>
...
<Navbar collapseOnSelect expand="lg" bg="light" variant="light" className="py-3 p-auto">
  ...
  <Carousel.Item className="">
    ...
    />
    <Carousel.Caption>
      <h5 className="display-3">First slide label</h5>
      <p className="display-3">Nulla vitae elit libero, a pharetra augue mollis interdum.</p>
    </Carousel.Caption>
  </Carousel.Item>
  <Carousel.Item>
    <img
