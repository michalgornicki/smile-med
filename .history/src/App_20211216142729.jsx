...
<Navbar collapseOnSelect expand="lg" bg="light" variant="light" className="py-5">
  ...
  <Navbar.Collapse id="responsive-navbar-nav">
    <Nav className="me-auto">
      <Nav.Link href="#features" className="mx-3 text-dark">Cennik</Nav.Link>
      <Nav.Link href="#pricing" className="mx-3 text-dar">Zespół</Nav.Link>
      <Nav.Link href="#pricing" className="mx-3 text-dar">Gabinet</Nav.Link>
      <Nav.Link href="#pricing" className="mx-3">Dla lekarzy</Nav.Link>
      <Nav.Link href="#pricing" className="mx-3">Aktualności</Nav.Link>
