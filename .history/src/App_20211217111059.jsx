...
<Navbar collapseOnSelect expand="lg" bg="light" variant="light" className="py-3 p-auto">
  ...
  <Carousel.Item className="">
    ...
    />
    <Carousel.Caption>
    <p className="display-7 my-0">Stawiamy na przyjazną atmosferę</p>
  ...
  <Carousel.Item>
    ...
    />
    <Carousel.Caption>
    <p className="display-7 my-0">Zapewniamy 100% zadowolenia z leczenia</p>
  ...
  <Carousel.Item>
    ...
    />
    <Carousel.Caption>
    <p className="display-7 my-0">Wysoka jakość usług, zadowoleni klienci</p>
    <h5 className="display-4 bold">Ortodoncja</h5>
    </Carousel.Caption>
  </Carousel.Item>
</Carousel>
    </p>
