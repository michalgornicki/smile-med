  ...
  <Navbar.Collapse id="responsive-navbar-nav">
    <Nav className="justify-content-start">
      ...
      <NavDropdown title="Usługi" id="collasible-nav-dropdown" className="mx-3 text-dark display-7">
        ...
        <NavDropdown.Item href="#action/3.4">Chirurgia stomatologiczna</NavDropdown.Item>
        <NavDropdown.Item href="#action/3.5">Chirurgia stomatologiczna</NavDropdown.Item>
        <NavDropdown.Divider />
        <NavDropdown.Item href="#action/3.4">Stomatologia dziecięca</NavDropdown.Item>
      </NavDropdown>
    </Nav>
  </Navbar.Collapse>
  </Container>
