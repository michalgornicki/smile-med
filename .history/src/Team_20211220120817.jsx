...
export default function Team() {
  ...
  <Card className="flex-lg-row mb-5">
    <Card.Img variant="top" src={Profile1} className="w-xxl-50 height-70vh h-sm-50"/>
    <Card.Body>
  ...
  <Card className="flex-lg-row mb-5">
    <Card.Img variant="top" src={Profile2} className="w-xxl-50  height-70vh" />
    <Card.Body>
  ...
  <Card className="flex-lg-row mb-5">
    <Card.Img variant="top" src={Profile3} className="w-xxl-50  height-70vh" />
    <Card.Body>
  ...
  <Card className="flex-lg-row mb-5">
    <Card.Img variant="top" src={Profile4} className="w-xxl-50  height-70vh" />
    <Card.Body>
