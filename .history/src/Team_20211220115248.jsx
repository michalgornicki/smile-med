...
export default function Team() {
  ...
  <Card className="flex-row mb-5">
    ...
    <Card.Body>
      <Card.Title className="display-5">dr Anna Michalska</Card.Title>
      <Card.Text>
  ...
  <Card className="flex-row mb-5">
    ...
    <Card.Body>
      <Card.Title className="display-5">dr Grzegorz Wiśniewski</Card.Title>
      <Card.Text>
  ...
  <Card className="flex-row mb-5">
    ...
    <Card.Body>
      <Card.Title className="display-5">dr Klaudia Jabłońska</Card.Title>
      <Card.Text>
        This is a wider card with supporting text below as a natural lead-in to
  ...
  <Card className="flex-row mb-5">
    ...
    <Card.Body>
      <Card.Title className="display-5">dr Piotr Stasiak</Card.Title>
      <Card.Text>
        This is a wider card with supporting text below as a natural lead-in to
        additional content. This card has even longer content than the first to
        show that equal height action.
