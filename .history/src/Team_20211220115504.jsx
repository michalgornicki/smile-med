...
export default function Team() {
  ...
  <Card className="flex-row mb-5">
    ...
    <Card.Body>
      <Card.Title className="display-656">Grzegorz Wiśniewski - lekarz stomatolog</Card.Title>
      <Card.Text>
  ...
  <Card className="flex-row mb-5">
    ...
    <Card.Body>
      <Card.Title className="display-6">Klaudia Jabłońska - lekarz stomatolog</Card.Title>
      <Card.Text>
        This is a wider card with supporting text below as a natural lead-in to
  ...
  <Card className="flex-row mb-5">
    ...
    <Card.Body>
      <Card.Title className="display-6">Piotr Stasiak - lekarz stomatolog</Card.Title>
      <Card.Text>
        This is a wider card with supporting text below as a natural lead-in to
        additional content. This card has even longer content than the first to
        show that equal height action.
