...
export default function Team() {
  ...
  <Card className="flex-row">
    <Card.Img variant="top" src={Profile1} className="w-50 mb-3 height-70vh"/>
    <Card.Body>
  ...
  <Card className="flex-row">
    <Card.Img variant="top" src={Profile2} className="w-50 mb-3 height-70vh" />
    <Card.Body>
      <Card.Title>Card title</Card.Title>
      <Card.Text>
  ...
  <Card className="flex-row">
    <Card.Img variant="top" src={Profile3} className="w-50 mb-3 height-70vh" />
    <Card.Body>
      <Card.Title>Card title</Card.Title>
      <Card.Text>
        This is a wider card with supporting text below as a natural lead-in to
  ...
  <Card className="flex-row">
    <Card.Img variant="top" src={Profile4} className="w-50 mb-3 height-70vh" />
    <Card.Body>
      <Card.Title>Card title</Card.Title>
      <Card.Text>
        This is a wider card with supporting text below as a natural lead-in to
