...
<Navbar collapseOnSelect expand="lg" bg="light" variant="light" className="py-5">
  ...
  <Navbar.Collapse id="responsive-navbar-nav">
    <Nav className="me-auto">
      <Nav.Link href="#features" className="mx-1">Cennik</Nav.Link>
      <Nav.Link href="#pricing" className="mx-1">Zespół</Nav.Link>
      <Nav.Link href="#pricing" className="mx-1">Gabinet</Nav.Link>
      <Nav.Link href="#pricing" className="mx-1">Dla lekarzy</Nav.Link>
      <Nav.Link href="#pricing" className="mx-1">Aktualności</Nav.Link>
      <NavDropdown title="Lista" id="collasible-nav-dropdown" className="mx-1">
