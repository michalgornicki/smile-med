...
<Navbar collapseOnSelect expand="lg" bg="light" variant="light" className="py-3 p-auto">
  ...
  <Carousel.Item className="">
    <img
      ...
      alt="First slide"
    />
    <Carousel.Caption className="float left" >
      <h5 className="display-3 bold text-light">Profesjonalizm</h5>
      <p className="display-7 text-light">Na maksymalnym poziomie.</p>
    </Carousel.Caption>
  </Carousel.Item>
  <Carousel.Item>
    <img
  ...
  <Carousel.Item>
    ...
    />
    <Carousel.Caption>
    <h5 className="display-3 bold text-light">Ortodoncja</h5>
      <p className="display-7 text-light">Wysoka jakość usług, zadowoleni klienci</p>
    </Carousel.Caption>
  </Carousel.Item>
</Carousel>
    </p>
