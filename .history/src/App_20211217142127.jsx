...
import Slide6 from "./5.jpg";
import Slide7 from "./5.jpg";
import Slide8 from "./5.jpg";
...
<Navbar collapseOnSelect expand="lg" bg="dark" variant="dark" className="py-5 p-auto mt-5">
  <Container>
  <Navbar.Toggle aria-controls="responsive-navbar-nav" />
  <Navbar.Collapse id="responsive-navbar-nav">
    <Nav className="justify-content-start">
