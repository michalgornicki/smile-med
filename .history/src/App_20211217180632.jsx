      ...
      <div>
        ...
        >
          <Container>
            ...
            <Navbar.Collapse id="responsive-navbar-nav">
              ...
              <Link to="/home"><Nav.Link className="mx-3 text-dark display-7">Zespół</Nav.Link></Link>
                <Link to="/team"><Nav.Link className="mx-3 text-dark display-7">Zespół</Nav.Link></Link>
        ...
        <div className="w-50 mx-auto my-5">
          <div>
            ...
            <div className="text-center">
              ...
              Państwa oraz naszych pracowników, uprzejmie prosimy o zapoznanie
              się i stosowanie do poniższej PROCEDURY NA CZAS PANDEMII COVID-19.
            </div>
          </div>
          ...
          <div>
            ...
            <div>
              ...
              Pacjenci z objawami grypopodobnymi: gorączka, kaszel, duszność
              itp., przesunęli termin swojej wizyty o co najmniej 14 dni
              <br></br>- zalecamy, by Pacjenci powyżej 65. r.ż. oraz z chorobami
              współistniejącymi przenieśli wizytę na późniejszy termin<br></br>-
              prosimy o punktualne przybycie do gabinetu i - jeśli jest to
              możliwe - bez osób towarzyszących<br></br>
            </div>
          </div>
          <div>
            <div className=" mt-4 very-bold display-7 text-center">
            ...
            <div>
              ...
              schowanie maseczki<br></br>- asystentka zmierzy Państwu
              temperaturę ciała. Jeśli wyniesie powyżej 37,3°C, wizyta musi
              zostać przełożona o minimum 14 dni<br></br>- prosimy o podpisanie
              oświadczenie dot. COVID-19 <br></br>- bezpośrednio przed wykonanym
              zabiegiem prosimy Państwa o przepłukanie ust roztworem płynu
        ...
        <CardGroup className="my-2 w-75 mx-auto">
          ...
          <Card className="mx-1">
            ...
            <Card.Body>
              <Card.Title>
                Błędy rodziców w dbaniu o uzębienie dzieci
              </Card.Title>
              <Card.Text>
