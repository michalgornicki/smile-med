...
<Navbar expand="lg" variant="light" bg="light">
  <Container>
  <Navbar.Brand href="#home"><span className="display-5 bold text-green p-2">SMILE MED</span></Navbar.Brand>
...
<div className="display-5 w-75 m-auto">Aktualności</div>
<CardGroup className="my-2 w-75 mx-auto">
<Card className="mx-1">

    <Card.Img variant="top" src={Slide1} />
    <Card.Body>
      <Card.Title>Szukamy lekarzy</Card.Title>
      <Card.Text>
  ...
  <Card className="mx-1">
    ...
    <Card.Body>
      ...
      <Card.Text>
      Z uwagi na fakt, że niewielu rodziców właściwie wdraża w życie zalecenia stomatologów 40 proc. dzieci w wieku dwóch lat ma próchnicę, wśród pięciolatków  wskaźnik ten wzrasta do 80 proc. W grupie nastolatków trudno znaleźć kogoś, kto nie miałby problemów z próchnicą.{' '}
      </Card.Text>
    </Card.Body>
    <Card.Footer>
  ...
  <Card className="mx-1">
    ...
    <Card.Body>
      ...
      <Card.Text>
      Dążenie do gwiazdorskiego uśmiechu nie powinno przysłonić najważniejszego aspektu, czyli zdrowych zębów i dziąseł. Zęby z próchnicą czy dziąsła zaatakowane przez paradontozę nie będą ładne, więc podstawą jest leczenie i profilaktyka. Sam fakt, że warunkiem koniecznym wybielania zębów jest wyleczona próchnica już powinien zapobiegać pominięciu tego etapu.
      </Card.Text>
    </Card.Body>
    <Card.Footer>
  ...
  <Card className="mx-1">
    ...
    <Card.Body>
      ...
      <Card.Text>
      Producenci środków certyfikowanych prowadzą badania skuteczności swoich produktów. To są długotrwałe i bardzo drogie badania. Na produktach profesjonalnych producentów widnieją numery norm i szczepy bakterii oraz typy wirusów, co do a których udowodniono skuteczność podczas badań.
      </Card.Text>
    </Card.Body>
    <Card.Footer>
      <small className="text-muted">15.11.2021</small>
    </Card.Footer>
  </Card>

</CardGroup>

<Navbar collapseOnSelect expand="lg" bg="dark" variant="dark" className="py-5 p-auto">
  <Container>
  <Navbar.Toggle aria-controls="responsive-navbar-nav" />
  <Navbar.Collapse id="responsive-navbar-nav">
    <Nav className="justify-content-start">
      ...
      <NavDropdown title="Usługi" id="collasible-nav-dropdown" className="mx-3 text-light display-7">
        <NavDropdown.Item href="#action/3.1">Ortodoncja</NavDropdown.Item>
        <NavDropdown.Item href="#action/3.2">Protetyka</NavDropdown.Item>
        <NavDropdown.Item href="#action/3.3">Chirurgia stomatologiczna</NavDropdown.Item>
        <NavDropdown.Divider />
